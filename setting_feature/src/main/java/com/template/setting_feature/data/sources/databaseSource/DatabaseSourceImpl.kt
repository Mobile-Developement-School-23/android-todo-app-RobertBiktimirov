...
import com.template.setting_feature.data.mappers.toDto
...
class DatabaseSourceImpl @Inject constructor(
    ...
    override suspend fun saveDataYandexAccount(yandexAccountEntity: YandexAccountEntity) {
        yandexAccountDao.deleteAccount()
        yandexAccountDao.setYandexAccount(yandexAccountEntity.toDto())
    }
}